...
import keyboard.neon.newboard.databinding.CrashDialogBinding
import keyboard.neon.newboard.debug.*
...
class CrashDialogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        errorReport.apply {
            ...
            appendLine("- FlorisBoard Version: ${pInfo.versionName} (${pInfo.versionCode})")
