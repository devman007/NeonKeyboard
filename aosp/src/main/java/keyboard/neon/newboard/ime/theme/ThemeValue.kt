...
import keyboard.neon.newboard.util.getId
import keyboard.neon.newboard.util.getMyDrawable
...
sealed class ThemeValue {
    ...
    data class Drawable(val name: String) : ThemeValue() {
        fun getDrawableId(context: Context) =
            context.getMyDrawable(context.getId(name))
    ...
    companion object {
        ...
        private val DECIMAL_REGEX = "^[0-9]*\\.?[0-9]*".toRegex()
        ...
        val UI_STRING_MAP: Map<String, Int> = mapOf(
            Pair(
                ...
                R.string.settings__theme_editor__value_type_reference
            ),
            Pair(
                SolidColor::class.simpleName!!,
                R.string.settings__theme_editor__value_type_solid_color
            ),
...
class ThemeValueSerializer : KSerializer<ThemeValue> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("ThemeValue", PrimitiveKind.STRING)
