...
class InputView : LinearLayout {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        heightFactor = when (resources.configuration.orientation) {
            Configuration.ORIENTATION_LANDSCAPE -> 1.2f
...
//        val smartbarDisabled =
//            !prefs.smartbar.enabled || florisboard.uiBinding?.text?.smartbar?.root?.visibility == View.GONE
...
//        florisboard.uiBinding?.text?.mediaInputTabs?.height?.let {
//            baseHeight += it
//        }

        // fonts tabbar height
//        baseHeight += ViewUtils.dp2px(48f)


        if (florisboard.uiBinding!!.text.adView.visibility == View.VISIBLE) {
            baseHeight += ViewUtils.dp2px(65f)
        }

//        if (florisboard.uiBinding!!.text.adView.isVisible)
//            baseHeight += florisboard.uiBinding!!.text.adView.height.toFloat()
//
