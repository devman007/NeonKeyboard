...
open class Theme(
    ...
    val animationName: String="neon1anim",
    val isNightTheme: Boolean = false,
    var attributes: Map<String, Map<String, ThemeValue>>
) : Asset {
    companion object {
        private val VALIDATION_REGEX_THEME_LABEL = """^.+${'$'}""".toRegex()
        private val VALIDATION_REGEX_GROUP_NAME =
            """^[a-zA-Z]+((:[a-zA-Z0-9_~]+)|(::[a-zA-Z]+)|(:[a-zA-Z0-9_~]+:[a-zA-Z]+))?${'$'}""".toRegex()
                ...
                attributes = mapOf(
                    Pair(
                        "window", mapOf(
                            ...
                            Pair(
                                "navigationBarColor",
                                ThemeValue.fromString("@keyboard/background")
                            ),
                    ...
                    Pair(
                        "key", mapOf(
                            ...
                            Pair(
                                "backgroundPressed",
                                ThemeValue.fromString("@window/semiTransparentColor")
                            ),
    ...
    ): Theme = Theme(name, label, authors, isNeon, animationName, isNightTheme, attributes)
    ...
    abstract class Attr {
        companion object {
            ...
            val WINDOW_SEMI_TRANSPARENT_COLOR =
                ThemeValue.Reference("window", "semiTransparentColor")
            val WINDOW_TEXT_COLOR = ThemeValue.Reference("window", "textColor")

            val TAB_SELECTED_TEXT_COLOR = ThemeValue.Reference("window", "tabTextSelected")
            val TAB_UNSELECTED_TEXT_COLOR = ThemeValue.Reference("window", "tabTextUnselected")

            val KEYBOARD_BACKGROUND = ThemeValue.Reference("keyboard", "background")
            val KEYBOARD_BG_DRAWABLE = ThemeValue.Reference("keyboard", "drawableImageName")
            ...
            val KEY_ELEVATION = ThemeValue.Reference("key", "elevation")
            val KEY_CORNER_RADIUS = ThemeValue.Reference("key", "cornerRadius")
            val KEY_STROKE_COLOR = ThemeValue.Reference("key", "strokeColor")
            ...
            val EXTRACT_EDIT_LAYOUT_BACKGROUND =
                ThemeValue.Reference("extractEditLayout", "background")
            val EXTRACT_EDIT_LAYOUT_FOREGROUND =
                ThemeValue.Reference("extractEditLayout", "foreground")
            val EXTRACT_EDIT_LAYOUT_FOREGROUND_ALT =
                ThemeValue.Reference("extractEditLayout", "foregroundAlt")

            val EXTRACT_ACTION_BUTTON_BACKGROUND =
                ThemeValue.Reference("extractActionButton", "background")
            val EXTRACT_ACTION_BUTTON_FOREGROUND =
                ThemeValue.Reference("extractActionButton", "foreground")
